...
def peak_signal_noise_ratio(
    ...
    """Computes the channel-wise peak signal to noise ratio (PSNR) for the given
    image(s).
    ...
    Code and tests are taken 1:1 from my
    https://github.com/cheind/pytorch-debayer/blob/04180a17af63c300b66f83a92d2b857ff13bd46f/debayer/metrics.py
